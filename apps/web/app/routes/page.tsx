      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-8 pb-6 border-b border-gray-800">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">{routes.length} aktive Strecken</p>
          </div>
          <Link
            href="/dashboard"
        ...
        <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-800">
              {routes.map((route) => (
                <tr key={route.id} className="hover:bg-gray-800/30 transition">
                  ...
                  <td className="px-4 py-3 text-right text-gray-300">{route.distanceNm} nm</td>
