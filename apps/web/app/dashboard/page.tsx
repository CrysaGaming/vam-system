                            ...
                            <div>
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-800 grid grid-cols-4 gap-4">
                                    <div>
                                        ...
                                        <p className="font-semibold mt-2">{user.rank?.name ?? 'Kein Rang'}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-500 uppercase tracking-wider text-xs">Rolle</p>
                                        <p className="font-semibold mt-2">{user.role?.name ?? 'Keine Rolle'}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-500 uppercase tracking-wider text-xs">Flugstunden</p>
                                        <p className="font-semibold mt-2">{user.totalFlightHours.toFixed(1)} h</p>
                                    </div>
                                    <div>
                    ...
                    >
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Verfügbare Strecken ansehen</p>
                            </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 opacity-50">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Flugberichte einreichen (bald verfügbar)</p>
                            </div>
