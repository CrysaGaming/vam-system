            ...
            <div className="max-w-6xl mx-auto">
                <header className="flex justify-between items-center mb-8 pb-6 border-b border-gray-800">
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">{pireps.length} eingereichte Flüge</p>
                    </div>
                ...
                {pireps.length === 0 ? (
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 text-center">
                        <p className="text-gray-400 mb-4">Du hast noch keine PIREPs eingereicht.</p>
                        <Link
                            href="/pireps/new"
                            className="inline-block px-5 py-2 bg-indigo-600 hover:bg-indigo-700 rounded transition"
                        >
