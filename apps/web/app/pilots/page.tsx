      ...
      <div className="max-w-6xl mx-auto">
        ...
        {pilots.length === 0 ? (
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 text-center">
            <p className="text-gray-400">Noch keine Piloten in dieser Airline.</p>
          </div>
        ) : (
                  ...
                  return (
                    <tr
                      ...
                      className={`group transition cursor-pointer ${
                        isMe ? 'bg-indigo-500/5 hover:bg-indigo-500/10' : 'hover:bg-gray-800/30'
                      }`}
                    >
                        ...
                        >
                          ...
                          <div>
                            <p className="font-semibold flex items-center gap-2">
                              ...
                              {isMe && (
                                <span className="text-xs text-indigo-400">(Du)</span>
                              )}
                            </p>
                          </div>
                        </Link>
