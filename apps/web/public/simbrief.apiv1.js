...
var api_dir = '/api/simbrief/'; // VAM-System: Next.js API routes proxy simbrief.apiv1.php
...
function do_simbriefsubmit(outputpage)
	...
	if (api_code == null || api_code == false || typeof(api_code) == 'undefined')
		{
		api_code = 'notset';
		sb_res_load(api_dir+'api-code?api_req='+document.getElementsByName('orig')[0].value+document.getElementsByName('dest')[0].value+document.getElementsByName('type')[0].value+timestamp+outputpage_calc);
...
function Redirect_caller()
	...
	*/
	...
	if (fe_result == null || fe_result == false || typeof(fe_result) == 'undefined')
		{
		fe_result = 'notset';
		sb_res_load(api_dir+'check-ofp?js_url_check='+ofp_id+"&var=fe_result");
